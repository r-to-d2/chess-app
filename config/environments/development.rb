Rails.application.configure do
  ...
  # is reloaded on every request. This slows down response
  # time but is perfect for development since you don't have
  # to restart the web server when you make code changes.
